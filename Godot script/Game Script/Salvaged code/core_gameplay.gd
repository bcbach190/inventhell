...
func _ready() -> void:
	...
	game.process_mode = Node.PROCESS_MODE_DISABLED # Disable processing temporarily
...
func _on_start_timer_timeout() -> void:
	...
	game.process_mode = Node.PROCESS_MODE_INHERIT # Resume gameplay processing (start game logic)
